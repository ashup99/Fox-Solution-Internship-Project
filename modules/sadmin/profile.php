...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    $sql_profile = "SELECT * FROM admin WHERE eid = '$eid'";
    ...
    <html>
    <head>
        <title><?php echo $fname.' '.$lname ?>-SAdmin-MIS</title>
    ...
    <div class="container">
        ...
        <div align="center">
            <p><b><i>Address:</i></b><?php echo $address.', '. $city.','.$postal_code ?></p>
            <p><b><i>Total Salary Per Month:</i></b><?php echo $salary; ?></p>
