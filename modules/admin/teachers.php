...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
            ...
            $eid_get_from_sql = preg_replace_callback("|(\d+)|", "increment", $eid_get_from_sql);
                    ...
                    <div align="center">
                        ...
                        <form method="post">
                            ...
                            <b>First Name:</b> <input type="text" name="fname" placeholder="First Name">
                            &nbsp;&nbsp;<b>Last Name:</b> <input type="text" name="lname" placeholder="Last Name">
 ...
 <?php    }?>
                    ...
                    if (isset($_POST['add'])) {
                        ...
                        $sql_get_insert = "INSERT INTO teachers (eid, fname, lname, email, mobile, address, city, postalcode, salary, position, subject, course, center, dateofjoining, experience, highestqualification, highestqualificationmarks, status) VALUES ('$eid_get_from_sql','$te_fname','$te_lname','$te_email','$te_mobile','$te_address','$te_city','$te_pin','$te_salary','$te_position','$te_subject','$course','$center','$te_dateofjoining','$te_experience','$te_highestqualification','$te_highestqualificationmarks','yes')";
        ...
        <option value="<?php echo $rowss['city']; ?>"><?php echo $rowss['city']; ?></option>
                                                        <?php while ($num = mysqli_fetch_assoc($resultc)) { ?>
                                                            <option value="<?php echo $num['city_name']; ?>"><?php echo $num['city_name']; ?></option>
                                                            <?php
                                                        }?>
