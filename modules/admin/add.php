        ...
        <?php
            if(isset($_GET['addbatch'])){ ?>
                <div align="center">
                    <form method="post">
                        ...
                        <br><b>Timings: Start</b><input type="time" name="timingstart" placeholder="Enter Batch timings">
                        <b>End</b><input type="time" name="timingend" placeholder="Enter Batch timings">
          ...
          <?php
                if(isset($_POST['batchadd'])){
                    ...
                    $timings_get = $_POST['timingstart']."-".$_POST['timingend'];
                    ...
                    if($sql_select_batch_query_chekc>0)
                    {
                       ...
                       echo "INSERT INTO batches (batch,timings,year,course,center) VALUES ('$batch_get','$timings_get','2018','$course','$center')";  
            ...
            if(isset($_GET['addtimetable'])){ ?>
                <div align="center">
                    <form method="post">
                        Subject:
                         <?php
                            $sql = "SELECT `subjects` FROM `subject` ORDER BY `subjects`";
                            ...
                            ?>
                                                    ...
                                                    <select class="custom-select d-block w-100" id="subject" name="subject" required>
                                                        ...
                                                        <?php }
    else {?>                                            <select class="custom-select d-block w-100" id="subject" name="subject" required>
                                                        <?php while ($num = mysqli_fetch_assoc($resultc)) { ?>
                                                            <option value="<?php echo $num['subjects']; ?>"><?php echo $num['subjects']; ?></option>
                                                            <?php
                                                        }?>
                                                    </select>
 <?php    }?>
                        <br>Timings: Start<input type="time" name="timingstart" placeholder="Enter Batch timings">
                        End<input type="time" name="timingend" placeholder="Enter Batch timings">
            ...
            <?php
                if(isset($_POST['inserttimetable'])){
                 ...
                 $get_timings = $_POST['timingstart']."-".$_POST['timingend'];
                 $get_day = $_POST['day'];
                ...
                <div align="center">
                    ...
                    <?php
                            ...
                            ?>
                                                    ...
                                                    <select class="custom-select d-block w-100" id="subject" name="teacher_subject" required>
                                                        <option value="">No subject Found</option>
                                                    </select>
                                                        <?php }
    else {?>                                            <select class="custom-select d-block w-100" id="subject" name="teacher_subject" required>
