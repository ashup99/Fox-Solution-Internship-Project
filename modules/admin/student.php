...
<?php if(isset($_GET['addstudent']) OR isset($_GET['batch'])) { ?>
 ...
 <?php    }?>
                    ...
                    <b>Date Of Leave:</b> <input type="date" name="dateoflev">
            ...
            if (isset($_POST['add'])) {
                ...
                $sql_get_insert = "INSERT INTO students(sid, fname, lname, email, phone, address, district, postalcode, fee, scholarship, paidfee, status, course, batch, class, fathername, fathermob, fatheroccu, mothername, mothermob, motheroccu, `10mark`, `12mark`, preexam, preexamyear, preexammarks, center, mentor, timing, dateofreg, pid, dateofleft) VALUES ('$sid','$st_fname','$st_lname','$st_email','$st_mobile','$st_address','$st_city','$st_pin','$st_fee','$st_schol','$paid_fee','yes','$course','$batch_get','$st_class','$st_fathername','$st_fathermob','$st_fatheroccu','$st_mothername','$st_mothermob','$st_motheroccu','$st_10mark','$st_12mark','$st_preexam','$st_preexamyear','$st_preexammarks','$center','$get_mentor','$get_timing','$st_dateofreg','$pid','$st_dateoflev')";
                echo $sql_get_insert;
...
?>
    <div align="center">
        ...
        <option value="<?php echo $rowss['district']; ?>"><?php echo $rowss['district']; ?></option>                                                
        <?php while ($num = mysqli_fetch_assoc($resultc)) { ?>
                                                            <option value="<?php echo $num['city_name']; ?>"><?php echo $num['city_name']; ?></option>
                                                            <?php
                                                        }?>
